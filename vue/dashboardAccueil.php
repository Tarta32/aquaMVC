...
<div class="container">
    ...
    <div class="row">
        <h2 class="text-center text-success mt-5"><u>Modification de "Acceuil" et "A propos"</u></h2>
        ...
        <div class="col-6">
            <form method="POST" action="<?= Conf::index ?>admin/update">
                <div class="form-group mt-3 mb-3">
                    <label for="inputDefault">Titre perso :</label>
                    <input type="text" class="form-control" id="inputDefault" value="<?= $accueil[0]["titre"] ?>" name="titrePerso">
                </div>
                <div class="form-group">
                    <label for="contenu" class="form-label mt-4">Contenu perso:</label>
                    <textarea name="contenuPerso" class="form-control" id="contenu" rows="6"><?= $accueil[0]["contenu"] ?></textarea>
                </div>
                <input class="btn btn-success mt-2" type="submit" value="Modifier contenu" name="updateAccueil">
            </form>
        </div>
