            ...
            <div class="row justify-content-center">
                <div class="col-6 text-center">
                    ...
                    <div class="form-group ">
                        <input name="token" type="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrez le code recu par mail">
                    </div>
                    <div class="row">
                        <div class="col">
                            <input name="valider" class="btn cssbuttons-io-button mt-5" type="submit" value="Reinitialiser">
                            <input name="retour" class="btn cssbuttons-io-button-red mt-5" type="submit" value="Annuler">
                        </div>
                    </div>
                </div>
            </div>
