    ...
    public function onload()
    {
        ...
        if (isset($_POST['valider'])) {
            ...
            if ($_POST['phone'] == "" || $_POST['phone'] == NULL) {
                ...
                mail("morgan.robert1987@gmail.com", $_POST['nom'] . " " . $_POST['prenom'], $_POST['message'], "From: " . $_POST['email']);
                ...
                mail("morgan.robert1987@gmail.com", $_POST['nom'] . " " . $_POST['prenom'] . " - Tel :" . $_POST['phone'], $_POST['message'], "From: " . $_POST['email']);
